    ...
    <nav className={navbarStylesDr.navContainer}>
      ...
      <img src={logo} alt="logo" className={navbarStylesDr.logoImage} />
        ...
        <div className={navbarStylesDr.brandTextContainer}>
         <div className={navbarStylesDr.brandTitle}>
          MedTrek
        </div> 
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `${navbarStylesDr.baseLink} ${
        isActive ? navbarStylesDr.activeLink : navbarStylesDr.inactiveLink
      }`
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `${navbarStylesDr.mobileBaseLink} ${
        isActive ? navbarStylesDr.mobileActiveLink : navbarStylesDr.mobileInactiveLink
      }`
    } onClick={() => setOpen(false)}
  >
