...
import fallbackImg from "../assets/placeholder-service.png";
import { Link, useParams, useNavigate } from "react-router-dom";
import { useAuth } from "@clerk/clerk-react";
import toast, { Toaster } from "react-hot-toast";
import { serviceDetailStyles, iconSize } from "../assets/dummyStyles";

const DEFAULT_HOST = import.meta.env.VITE_BACKEND_URL || "https://meditrack-hospital-management-1.onrender.com".replace(/\/$/, "");
...
export default function ServiceDetail() {
  ...
  const firstDate = transformed.dates[0];
  const firstTime = transformed.slots?.[firstDate]?.[0] || "";
  ...
  function transformServiceShape(doc) {
    ...
    out.image =
  doc.imageUrl || doc.image || doc.imageURL || doc.image_path || "";
    out.price =
...
try {
  res = await fetch(`${DEFAULT_HOST}/api/service-appointments`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
setSubmitError(err?.message || "Network error while creating booking.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  <div className={serviceDetailStyles.noSlotsMessage}>
    No slots available for this date.
          ...
          <div>
            ...
            <button
              disabled={!isLoaded || !isSignedIn || !isFormValid() || submitting}
