...
export const bannerStyles = {
  ...
  outerAnimatedBand: "absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-500 via-emerald-300 to-green-400 animate-[spin_3s_linear_infinite] opacity-80",
  ...
  stethoscopeInner: "relative bg-gradient-to-br from-blue-300 to-emerald-600 p-3 rounded-full shadow-lg transform -rotate-6 hover:rotate-0 transition-transform duration-300",
  stethoscopeIcon: "w-7 h-7 text-white",
  
  // Title styles
  titleContainer: "font-[pacifico]",
  title: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-grey-400 mb-1",
  titleGradient: "text-transparent bg-gradient-to-r from-blue-400 to-emerald-600 bg-clip-text",
  ...
  // Tagline
  tagline: "text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-black-900 mb-5 leading-tight",
...
export const footerStyles = {
  // Main container
  footerContainer: "relative font-serif bg-gradient-to-br from-emerald-50 via-blue-50 to-teal-50 border-t border-emerald-200 overflow-hidden",
  ...
  activityIcon: "w-5 h-5 text-blue-400",
  ...
  companyName: "inline-block text-2xl md:text-3xl lg:text-3xl font-bold bg-gradient-to-r from-emerald-600 via-teal-500 to-sky-500 bg-clip-text text-transparent font-['Poppins'] tracking-tight",
  companyTagline: "inline-block text-transparent bg-gradient-to-r from-emerald-500 to-teal-400 bg-clip-text font-serif text-xs md:text-sm font-semibold tracking-wide mt-1",
companyDescription: "text-slate-600 font-serif italic mb-5 leading-relaxed text-sm md:text-base font-light",
...
export const navbarStyles = {
  ...
  logoTitle: "text-2xl md:text-2xl lg:text-2xl xl:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-sky-400 tracking-tight",
  logoSubtitle: "text-xs lg:text-xs text-gray-500",
  
  // Desktop navigation
  desktopNav: "hidden lg:-mx-5 lg:flex items-center gap-3",
  navItemsContainer: "flex gap-1 bg-white border border-emerald-300 p-1 rounded-full shadow-lg",
  navItem: "nav-item px-6 md:px-6 py-3.5 rounded-full text-base font-semibold transition-all duration-300",
  navItemActive: "active",
  navItemInactive: "text-grey-600 hover:text-emerald-400",
  ...
  doctorAdminIcon: "w-6 h-6",
  doctorAdminText: "hidden sm:inline-block text-xs md:text-sm lg:text-base whitespace-nowrap",
  loginButton: "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-linear-to-r from-emerald-400 to-blue-400 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",
