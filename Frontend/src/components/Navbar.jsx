...
import { ClerkProvider, SignedIn, SignedOut, useClerk, UserButton } 
from "@clerk/clerk-react";
import { Key, Menu, User, X } from 'lucide-react';
import logo from '../assets/MediTrack.png';
...
// Sync the Doctor Login State across tabs
  ...
  // close toggle menu when clicking outside of it box
  useEffect(() => {
...
<div className={navbarStyles.contentWrapper}>
  <div className={navbarStyles.flexContainer}>
    ...
    <div className={navbarStyles.logoImageWrapper}>
      <img src ={logo} alt="MediTrack Logo" className={navbarStyles.logoImage}/>
    </div>
    </div>
    <div className={navbarStyles.logoTextContainer}>
      <h1 className={navbarStyles.logoTitle}>MediTrack</h1>
      <p className={navbarStyles.logoSubtitle}> HealthCare Solutions
      </p>
    </div>
    </Link>

    <div className={navbarStyles.desktopNav}>
      <div className={navbarStyles.navItemsContainer}>{navItems.map((item)=> {
...
className={navbarStyles.loginButton}>
  <Key className={navbarStyles.loginIcon}/> Login</button>
    </SignedOut>
