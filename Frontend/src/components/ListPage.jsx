        ...
        <div>
          ...
          <div className={listPageStyles.searchContainer}>
           <div className={listPageStyles.searchIconContainer}>
            ...
            <input value={search} onChange={(e) => setSearch(e.target.value)} className={listPageStyles.searchInput} placeholder="Search by patient name"
            />
            {search && (
            ...
            {filtered.map((a) => (
              ...
              <header className={listPageStyles.cardHeader}>
                <div className={listPageStyles.cardAvatar}>
                  {a.doctorImage ? (
                    <img src={a.doctorImage} alt={a.doctorName} className={listPageStyles.cardAvatarImage}
