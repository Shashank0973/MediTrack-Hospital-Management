    ...
    <div>
     ...
     <div className ={certificationStyles.headingInner}>
      ...
      <h2 className={certificationStyles.title}>
       <span className={certificationStyles.titleText}>CERTIFIED AND EXCELLENCE
      </span> 
      </h2>
     </div>

     <p className={certificationStyles.subtitle}>
       We are proud to be certified and recognized for our excellence in healthcare services.
     </p>
    ...
    <div className={certificationStyles.logosMarquee}>
      {duplicatedCertifications.map((cert, index) => (
        ...
        <div className="relative">
          ...
          <span className={certificationStyles.logoText}>{cert.name}
          </span>
       </div>
      </div>
      ))}
     ...
     <style>{certificationStyles.animationStyles}
     </style>
  </div>
  );
};
