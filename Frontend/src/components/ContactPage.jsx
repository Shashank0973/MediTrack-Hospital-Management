...
{/* Phone + Department */}
            ...
            <div>
              ...
              <select
                ...
                className={contactPageStyles.input}
              >
                <option value="">Select Service (or choose Department above)
                </option>
    ...
    <div className={contactPageStyles.infoContainer}>
      <div className={contactPageStyles.infoCard}>
        ...
        <p className={contactPageStyles.infoItem}>
          <Phone size={16} /> 8950661075
        </p>
        <p className={contactPageStyles.infoItem}><Mail size={16} /> info@yourclinic.com
        </p>
    </div>
         
         <iframe
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3530.8820746682663!2d78.0789774!3d30.400197499999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3908d70603f128a5%3A0x359bb8f9c7797984!2sDIT%20University%2C%20Dehradun!5e1!3m2!1sen!2sin!4v1777486407345!5m2!1sen!2sin"
  width="100%"
  height="300"
  style={{ border: 0 }}
  allowFullScreen
...
/>
   ...
   <div className={contactPageStyles.hoursContainer}>
    ...
    <p className={contactPageStyles.hoursText}>Monday - Friday: 9:00 AM - 6:00 PM
      </p>
   </div>
    </div>
    </div>
